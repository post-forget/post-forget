...
LIGHTEVAL_TASKS_FEW_SHOT=./src/experiments/custom_tasks_extractor_few_shot.py
LIGHTEVAL_TASKS_PROMPT=./src/experiments/custom_tasks_extractor_prompt.py
...
for model in "${MODELS[@]}"; do
  ...
  for task_dir in "${TASKS_BASE_DIR}"/*; do
      python ./src/experiments/eval_models.py \
